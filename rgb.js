 ...
 * @changelog
 * Added support for getRGBA() - richard_anaya
 * Added support for HSL HSV conversion - richard_anaya
 */
function RGBColor(color_string)
{
    ...
    this.lighten = function(amount) {
        ...
        this.r = Math.floor(rgb[0]);
        this.g = Math.floor(rgb[1]);
        this.b = Math.floor(rgb[2]);
    };
